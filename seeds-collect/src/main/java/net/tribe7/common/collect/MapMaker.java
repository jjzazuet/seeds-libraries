...
import static net.tribe7.common.collect.MapMakerInternalMap.Strength.SOFT;
...
import net.tribe7.common.collect.MapMakerInternalMap.Strength;
...
public final class MapMaker extends GenericMapMaker<Object, Object> {
   ...
   * {@link net.tribe7.common.cache.CacheBuilder}.
   *
   * @param size the maximum size of the map
   * @throws IllegalArgumentException if {@code size} is negative
   * @throws IllegalStateException if a maximum size was already set
   * @deprecated Caching functionality in {@code MapMaker} has been moved to
   *     {@link net.tribe7.common.cache.CacheBuilder}, with {@link #maximumSize} being
   *     replaced by {@link net.tribe7.common.cache.CacheBuilder#maximumSize}. Note that {@code
   ...
   * @deprecated Caching functionality in {@code MapMaker} has been moved to
   *     {@link net.tribe7.common.cache.CacheBuilder}, with {@link #expireAfterWrite} being
   *     replaced by {@link net.tribe7.common.cache.CacheBuilder#expireAfterWrite}. Note that {@code
   *     CacheBuilder} is simply an enhanced API for an implementation which was branched from
   *     {@code MapMaker}.
   */
  @Deprecated
   ...
   * @deprecated Caching functionality in {@code MapMaker} has been moved to
   *     {@link net.tribe7.common.cache.CacheBuilder}, with {@link #expireAfterAccess} being
   *     replaced by {@link net.tribe7.common.cache.CacheBuilder#expireAfterAccess}. Note that
   ...
   * @deprecated Caching functionality in {@code MapMaker} has been moved to
   *     {@link net.tribe7.common.cache.CacheBuilder}, with {@link #removalListener} being
   *     replaced by {@link net.tribe7.common.cache.CacheBuilder#removalListener}. Note that {@code
   *     CacheBuilder} is simply an enhanced API for an implementation which was branched from
   *     {@code MapMaker}.
   */
  @Deprecated
   ...
   *
   * <p>New code should use {@link net.tribe7.common.cache.CacheBuilder}, which supports
   * {@linkplain net.tribe7.common.cache.CacheStats statistics} collection, introduces the
   * {@link net.tribe7.common.cache.CacheLoader} interface for loading entries into the cache
   ...
   * @return a serializable concurrent map having the requested features
   * @deprecated Caching functionality in {@code MapMaker} has been moved to
   *     {@link net.tribe7.common.cache.CacheBuilder}, with {@link #makeComputingMap} being replaced
   *     by {@link net.tribe7.common.cache.CacheBuilder#build}. See the
